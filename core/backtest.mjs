 ...
 *
 * عدد اجرایی از این داده ساختنی نیست، چون تابلو دفتر سفارش تاریخی نمی‌دهد.
 * پس به‌جای ساختنِ عددی که ادعای اجرا داشته باشد، نامش عوض شد: رابط این
 * نمودار را «ارزش مشاهده‌شدهٔ موقعیت · مرجع، نه قابل آفست» می‌نامد.
 */
