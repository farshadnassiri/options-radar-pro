...
export const SCHEMA = [
  ...
  { key: 'comboWindowMode', group: 'combo', kind: 'pick', scope: 'client',
    ...
    hint: 'خودکار هیچ قیمت اعمالی را کنار نمی‌گذارد مگر سقف ترکیب مجبور کند؛ آن‌وقت دورترین‌ها از قیمت پایه کنار می‌روند و شمارشان گفته می‌شود. «درصد ثابت» رفتار نسخه‌های پیشین است و برای بازتولید نتیجه قدیمی مانده.' },
