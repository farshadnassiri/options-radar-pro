...
export const SCHEMA = [
  ...
  { key: 'marginBBasis', group: 'margin', kind: 'pick', scope: 'client',
    def: 'STRIKE',
    options: [
      ['STRIKE', 'قیمت اعمال — متن ضوابط'],
      ['SPOT', 'قیمت پایانی پایه — سازگاری با نمونه‌های قدیمی تابلو'],
    ],
    label: 'مبنای جزء B وجه تضمین',
    hint: 'ضوابط، جزء B را بر قیمت اعمال می‌گیرد. حالت قیمت پایه فقط برای تطبیق با شش نمونهٔ قدیمی و بی‌مهرزمان تابلو نگه داشته شده است. روی ۷٬۹۲۵ پای فروش، بیشینه اختلاف دو مبنا ۷٫۳۴ میلیون ریال بود.' },
  { key: 'nakedComboMargin', group: 'margin', kind: 'pick', scope: 'client',
    def: 'MAX_PLUS_PREMIUM',
    options: [
      ['MAX_PLUS_PREMIUM', 'بزرگ‌تر + پریمیوم قرارداد با تضمین اولیه کمتر — ضوابط'],
      ['SUM', 'جمع دو پا — سناریوی محافظه‌کارانه'],
    ],
    label: 'وجه تضمین فروش هم‌زمان کال و پوت',
    hint: 'استرادل و استرانگل فروش هم‌ماه. ضوابط به‌جای جمع، بزرگ‌ترِ وجه تضمین لازم دو پا را با پریمیوم قراردادی جمع می‌کند که وجه تضمین اولیه کمتری دارد. فقط تعداد برابر دو سمت جفت می‌شود؛ مازاد یک سمت وجه تضمین مستقل دارد. حالت جمع صرفاً سناریوی محافظه‌کارانه است.' },
