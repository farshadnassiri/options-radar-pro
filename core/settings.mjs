...
export const SCHEMA = [
  ...
  { key: 'contractSize', group: 'basis', kind: 'num', scope: 'client',
    ...
    hint: 'هر قرارداد اختیار سهام در بورس تهران روی ۱۰۰۰ سهم پایه بسته می‌شود. اگر مشخصات خودِ قرارداد اندازه دیگری بدهد — مثلاً پس از افزایش سرمایه — همان مقدم است و این عدد فقط وقتی به کار می‌آید که مشخصات در دست نباشد.' },
