...
//
// همه عددها فارسی نوشته می‌شوند: رقم فارسی، اعشار «٫»، و منفی با نشانه
// ریاضی «−» نه خط تیره.
//
// جداکننده هزارگان اما **کاما** است، نه «٬» فارسی. خواستهٔ صاحب پروژه
// (۱۴۰۵/۰۶/۲۵): «جداکننده‌های سه‌رقمی ارقام کاما باشد.» دلیلش خوانایی است
// و درست هم هست: «٬» یک خطِ مویِ کوتاه است که در اندازهٔ جدول تقریباً
// نامرئی می‌شود و «۱۲۳۴۵۶» با «۱٬۲۳۴٬۵۶» یک شکل دیده می‌شوند. کاما در
// همان اندازه جدا می‌ایستد.
//
