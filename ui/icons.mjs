...
const PATHS = {
  ...
  // «افزودن»: همان صلیبِ ساده، با همان ضخامتِ خانواده. ایموجیِ ➕ رنگِ
  // خودش را دارد و در پوستهٔ تیره روی دکمهٔ خاکستری می‌نشیند بی آنکه
  // رنگِ متن را بگیرد؛ این یکی `currentColor` است.
  plus: '<path d="M12 5v14M5 12h14"/>',
  // شرطِ خاموش. پیش از این ⏸ بود، در خانهٔ عددیِ جدول — ایموجی در ستونی
  // که `tabular-nums` دارد عرضِ ستون را هم می‌لرزاند.
