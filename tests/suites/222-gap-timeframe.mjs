// ۲۲۲. تایم‌فریم فاصله، و رفتارش در برابر دارایی پایه
//
...
group('۲۲۲-الف. تایم‌فریم و مقایسه با دارایی پایه');
{
...
group('۲۲۲-ب. سررسیدی که پنجرهٔ روز بیرونش می‌گذارد، شمرده می‌شود');
{
