...
import {
  parseTomanInput, parsePercentInput, tomanToRial, previewPortfolioCapital,
  createPortfolioStepOneDraft, createPortfolioOutlookDraft,
...
group('۱۱۶. UI مأموریت — انتظار بازار');
{
  ...
  check('مرحله انتظار در موبایل تک‌ستونه می‌شود',
    css.includes('.pt-choice-grid, .pt-volatility-grid, .pt-outlook-price-grid, .pt-outlook-detail-grid { grid-template-columns: 1fr; }'));
}
